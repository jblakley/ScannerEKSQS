#!/usr/bin/env bash
## Configure Ubuntu 16.04 Instance AWS for EKS and spark
## Must be root
apt update
...
REPO=HermesPeak
REPODIR=$REPO/SparkPG/SparkEKSQS
QSHOME=~/git/${REPODIR}
...
test -d $REPO || git clone -b $BRANCH https://github.com/jblakley/$REPO

cd $QSHOME
python3 ./spark_EKS_builder.py --staging
